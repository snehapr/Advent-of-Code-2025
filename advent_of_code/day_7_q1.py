...
def simulate_beams(grid):
    ...
    # Start: beam goes down from S
    sr, sc = find_start(grid)
    beams.append((sr + 1, sc, 'down'))
    ...
    while beams:
        ...
        while 0 <= r < rows and 0 <= c < cols:
            ...
            if cell == '^':
                ...
                r += 1  # Treat any other cell as empty

    return split_count

grid = read_grid("tachyon_beams.txt")
result = simulate_beams(grid)
print("Total number of splits:", result)
#Total number of splits: 1622